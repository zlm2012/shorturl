...
var opts struct {
	...
	EnableCache bool     `long:"cache" description:"enable cache" default:"true"`
}
...
func main() {
	...
	redirecter, err := shorturl.NewRedirecter(opts.Filenames, opts.BaseUrl, opts.Strict, opts.EnableCache)
	if err != nil {
		log.Fatalln(err)
	}
